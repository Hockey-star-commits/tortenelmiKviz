...
for (let i = 0; i < 3; i++) {
    for (let j = 0; j < 4; j++) {
       sz+= `<img id="${szamlalo}" onmouseover="szegelyRajzol(this.id)" onmouseout="szegelyTorol(this.id)" onclick="nagyit(this.id)" src="a${szamlalo}.jpg" alt="" style="width:100px;margin:5px; border="1px solid white";>`
       szamlalo++
